<template>
	<div>
		<el-card class="box-card">
			...
			<el-alert class="warning" title="Tips" :closable="false" type="warning" description="设置后台管理系统的左侧菜单，目前至多支持两层菜单，三层以上菜单将不会显示。"
			 show-icon>
			</el-alert>
			<!-- 树形组件   -->
			<el-tree ref="tree" lazy :load="loadNode" node-key="id" :default-expanded-keys="[0]" :props="defaultProps">
				<span class="custom-tree-node" slot-scope="{ node, data }">
					...
					<span>
						...
						<span class="title" style="font-size: 5px;">显示序号:</span>
			...
			<!-- 图标弹窗 -->
			<el-dialog class="picture" title="修改图标" :visible.sync="editIconShow" width="79%">
				<ul class="icon_box">
